...
export default function Announcement() {
  const announcements = [
    {
      text: "Check our best sellers out! ✨",
      link: "/collections/bestsellers",
    },
    {
      text: "Warm. Spicy. Refreshing 🫚 Presenting Sepoy & Co. Premium Ginger Beer",
      link: "/products/premium-ginger-beer",
    },
    {
      text: "Sepoy & Co. Sparkling Mineral Water - Born in the peaks, crafted by time, & enriched with Himalayan balance.",
      link: "/products/sparkling-mineral-water",
    },
  ];
