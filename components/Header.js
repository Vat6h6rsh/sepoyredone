    ...
    <header className="bg-white shadow-md">
      ...
      <div className="flex justify-center py-2">
        <div className="w-32 relative group">
          <a href="/" className="block transition-all duration-300 ease-in-out">
      ...
      <div className="hidden md:flex items-center justify-between py-4 px-8">
        ...
        <nav className="flex-grow">
          <ul className="flex justify-center space-x-8">
            ...
            <li>
              <a href="#Our_Story" className="text-gray-700 hover:text-black">
                Our Story
              </a>
            </li>
            <li>
              <a href="#Recipies" className="text-gray-700 hover:text-black">
                Recipies
              </a>
            </li>
            <li>
              <a href="#Awards" className="text-gray-700 hover:text-black">
                Awards
              </a>
            </li>
            <li>
              <a
                href="pages/pairing-chart"
            ...
            <li>
              <a href="#Loyalty" className="text-gray-700 hover:text-black">
                Loyalty Program
              </a>
            </li>
          </ul>
